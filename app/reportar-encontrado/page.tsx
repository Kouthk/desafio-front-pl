        ...
        <div className="container py-12">
          <div className="mx-auto max-w-3xl space-y-6">
            <div className="space-y-2 text-center">
              <h1 className="heading-2">Reportar Pessoa Encontrada</h1>
              <p className="text-text-secondary">
                Preencha o formulário abaixo com informações sobre a pessoa encontrada. Quanto mais detalhes você
                fornecer, maiores as chances de reconectá-la com sua família.
              </p>
            </div>

            <Card className="shadow-md overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-secondary to-highlight text-primary-dark">
                <CardTitle>Formulário de Registro</CardTitle>
                <CardDescription className="text-primary-dark/80">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="descricaoPessoa" className="text-text-secondary">
                        Descrição da Pessoa *
                      </Label>
                      <Textarea
                        id="descricaoPessoa"
                        name="descricaoPessoa"
                        placeholder="Descreva a pessoa encontrada (aparência, comportamento, etc.)"
                        className="min-h-[100px] border-gray-300 focus:border-primary focus:ring-primary"
                        value={formData.descricaoPessoa}
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div className="space-y-2">
                        <Label htmlFor="idadeAproximada" className="text-text-secondary">
                          Idade Aproximada *
                        </Label>
                        <Input
                          id="idadeAproximada"
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div className="space-y-2">
                        <Label htmlFor="dataEncontro" className="text-text-secondary">
                          Data do Encontro *
                        </Label>
                        <Input
                          id="dataEncontro"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="localEncontro" className="text-text-secondary">
                          Local do Encontro *
                        </Label>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="circunstancias"
                        name="circunstancias"
                        placeholder="Descreva detalhadamente as circunstâncias em que a pessoa foi encontrada"
                        className="min-h-[100px] border-gray-300 focus:border-primary focus:ring-primary"
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="vestimentas"
                        name="vestimentas"
                        placeholder="Descreva as roupas e acessórios que a pessoa estava usando"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="condicaoSaude" className="text-text-secondary">
                        Condição de Saúde *
                      </Label>
                      <Textarea
                        id="condicaoSaude"
                        name="condicaoSaude"
                        placeholder="Descreva a condição de saúde da pessoa (física e mental)"
                        className="min-h-[80px] border-gray-300 focus:border-primary focus:ring-primary"
                  ...
                  <div className="flex flex-col sm:flex-row justify-end gap-4">
                    ...
                    <Button
                      ...
                      className="bg-secondary text-primary-dark hover:bg-accent hover:text-white"
                    >
                      {isSubmitting ? (
                        <>
